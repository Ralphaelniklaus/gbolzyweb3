...
export default function ArtistModal({ status }) {
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                              Your Artist Profile has been created. You're our latest artist.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-ld px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                      <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                          ...
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              An error has occurred while creating your Profile. We're really sorry.
                              Please try again.
                            </p>
                          </div>
                        </div>
