...
export default function CollectionModal({ status }) {
              ...
              >
                <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg w-[80%] sm:w-full">
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                              Your Collection has been created. You can view it in the Collections page.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-ld px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse sm:items-center">
                    <button
                      type="button"
                      className="w-full inline-flex bttn-4 bttn-secondary sm:ml-3 sm:w-auto sm:text-sm"
            ...
            <div className="fixed z-10 inset-0 overflow-y-auto">
              <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
                <Transition.Child
                  ...
                  leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                >
                  <Dialog.Panel className="relative bg-ld rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg w-[80%] sm:w-full">
                    <div className="bg-ld px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                      <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                          ...
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              An error has occurred while creating your collection. We're really sorry.
                              Please try again.
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="bg-ld px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                      <button
                        type="button"
