           ...
           <div className="mb-4">
                <Link to="/" className="font-bold text-center align-middle text-black text-2xl">
                    <span className="text-indigo-600">
                        Free<span className="text-gray-900 dark:text-gray-200">Chain</span>
                     </span>  
                </Link>
            </div>
            <p className='text-xs md:text-sm'>
              Free Decentralized Digital MarketPlace, Zero censorship, fast transactions with cheap fees, on Polygon Network.</p>
        </div>
        {/* Second Grid */}
        <div className="col-span-2 grid grid-cols-2 sm:grid-cols-4 gap-y-8 text-xs md:text-sm lg:gap-y-0 lg:grid-cols-4">
          <div>
            <h1 className='text-base lg:text-md font-medium text-slate-500 dark:text-slate-100'>COMPANY</h1>
